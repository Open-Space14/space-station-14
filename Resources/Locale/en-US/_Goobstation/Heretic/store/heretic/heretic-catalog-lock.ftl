...
knowledge-path-lock-s2-desc =
    ...
    Благодаря Хватке Мансуса. вы можете получить доступ к чему угодно! Щелкните правой кнопкой мыши на шлюзе или шкафчике, чтобы открыть его.
    Все замки сломаются. Любой пилот меха будет мгновенно катапультирован. Консоли ломаются.
...
knowledge-path-lock-s9-desc =
    ...
    Дает вам заклинание, делающее вас прозрачным и неплотным. Нельзя использовать рядом с живыми разумными существами.
