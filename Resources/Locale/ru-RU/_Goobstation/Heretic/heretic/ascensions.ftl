heretic-ascension-ash =
    Дозор мертв, и Ночной Дозор сгорел вместе с ним. Но его огонь горит вечно,
    ибо Ночной Дозор принес человечеству обряд! Его взгляд продолжается, и теперь я един с пламенем,
    СВИДЕТЕЛЬ МОЕГО ВОСХОЖДЕНИЯ, ПЕПЕЛЬНЫЙ ФОНАРЬ ПЫЛАЕТ ВНОВЬ!
heretic-ascension-blade =
    Разорванный чемпион освобожден! Я стану воссоединенным клинком, и с моими большими амбициями,
    МНЕ НЕТ РАВНЫХ! БУРЯ СТАЛИ И СЕРЕБРА НАДВИГАЕТСЯ НА НАС! СТАНЬТЕ СВИДЕТЕЛЕМ МОЕГО ВОСХОЖДЕНИЯ!
heretic-ascension-lock =
    Стюарды вели меня, а я вел их.
    Мои враги были замками, а мои клинки - ключами!
    Лабиринт больше не будет заперт, и мы обретем свободу! СМОТРИТЕ НА НАС!
...
heretic-ascension-void =
    ...
    пока мир разрушается на наших глазах. Пустота вернет все в ничто, УВИДЬТЕ МОЕ ВОЗНЕСЕНИЕ!
