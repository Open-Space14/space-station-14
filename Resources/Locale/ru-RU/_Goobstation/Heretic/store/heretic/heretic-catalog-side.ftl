...
knowledge-path-side-s9-cleave-name = Кровоток
knowledge-path-side-s9-cleave-desc =
    ...
    Дает вам Кровоток, заклинание направленного действия, вызывающее сильное кровотечение и потерю крови у всех, кто пострадал.
