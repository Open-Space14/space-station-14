...
knowledge-path-blade-s2-name = Хватка Мансуса
knowledge-path-blade-s2-desc =
    ...
    Ваша Хватка Мансуса вызывает короткое оглушение, если использовать его на лежащего или стоящего лицом к вам человека.
...
knowledge-path-blade-s4-desc =
    ...
    Теперь ваша Хватка Мансуса применяет Знак клинка.
...
knowledge-path-blade-s6-desc =
    Со временем он остался один среди тел своих бывших товарищей, залитых кровью, но не его собственной. У него не было ни соперников, ни равных, ни цели.
    
    Дает иммунитет к расчленению конечностей.
    Кроме того, при уроне ниже 50% максимального здоровья вы получаете повышенное сопротивление к получению ран и устойчивость к дубинкам.
