...
knowledge-path-void-s5-desc =
    ...
    Дает вам заклинание Удар Пустоты., которое выстреливает перед вами конусом ледяной взрыв,
...
knowledge-path-void-s7-desc =
    Мимолетные воспоминания, мимолетные шаги. Я отмечаю свой путь застывшей кровью на снегу. Застывшей и забытой.
...
knowledge-path-void-s8-desc =
    ...
    Наделяет вас заклинанием Пустотный Толчок, которое притягивает к вам всех ближайших язычников, ненадолго оглушая их.
