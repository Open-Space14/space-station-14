...
alert-level-epsilon-announcement = Центральное командование объявило на станции уровень угрозы "Эпсилон". Все контракты были расторгнуты. Спасибо, что выбрали NanoTrasen!
alert-level-epsilon-instructions = Все контракты были расторгнуты. Спасибо, что выбрали NanoTrasen!
